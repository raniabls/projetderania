...
<div class="container">
    <form action="" id="taskform">
     ...
     <div class="itemswrap">
      ...
      <input class="title" id="tasktitle" placeholder="Enter le titre de votre tache " name="Titres" value="{{$todo->Titres}}"/>
    </div>

     <div class="itemswrap">
       <label for="taskdate">Date </label>
       <input type="date" id="taskdate" name="Date" value="{{$todo->Date}}"/>
     </div>
   
     <div class="itemswrap">
       <label for="tasktime"> Temps</label>
       <input type="time" id="tasktime" name="Temps" value="{{$todo->Temps}}"/>
       </div>
       
     <div class="itemswrap">
       <label for="taskcategorie"> Categorie</label>
       <select name="Categorie" id="taskcategorie" value="{{$todo->Categorie}}"> 
     ...
     <textarea name="Détails" id="taskdetails" placeholder="Ecrivez les details de votre tache" value="{{$todo->Détails}}"> </textarea>
