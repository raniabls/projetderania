...
<table> 
    ...
    <form action="{{route('application')}}">
        <label>Quand vous terminez de choisir les couleurs qui vous conviennent, vous pouvez commencer à lister vos tâches </label>
        <button class="login-popup">Ici</button>
    </form>
